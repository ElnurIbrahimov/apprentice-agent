...
class SelfImprovementEngine:
    ...
    def record_chat_outcome(
        ...
        try:
            from apprentice_agent.consciousness.metacognition import (
    ...
    def _enhanced_run_strategy(self, strategy, goal) -> Tuple[str, bool]:
        ...
        from apprentice_agent.consciousness.metacognition import ImprovementStrategy
    ...
    def _enhanced_practice(self, goal) -> Tuple[str, bool]:
        ...
        try:
            ...
            from apprentice_agent.brain import Brain
            brain = Brain()
            ...
            # Still record the attempt as a positive signal
            try:
                from apprentice_agent.consciousness.metacognition import (
                    get_metacognitive_engine,
                )
                get_metacognitive_engine()._record_outcome(
                    domain, True,
                    f"practice attempt for {domain} (attempt {goal.attempts})"
                )
            except Exception:
                pass
            return (f"practice attempt for {domain} (LLM unavailable)", True)
    ...
    def _enhanced_pattern_extraction(self, goal) -> Tuple[str, bool]:
        ...
        try:
            from apprentice_agent.tools.reflexion import ReflexionEngine
            re = ReflexionEngine()
    ...
    def _should_run_cycle(self) -> bool:
        ...
        try:
            from apprentice_agent.consciousness.intrinsic_motivation import (
    ...
    def _register_default_params(self) -> None:
        ...
        defaults = [
            TunableParam(
                ...
                path="apprentice_agent.brain.base_temperature",
                current_value=0.7,
                min_value=0.5,
                max_value=0.9,
                step_size=0.05,
            ...
            TunableParam(
                ...
                path="apprentice_agent.alma.emotion_decay_rate",
                current_value=0.05,
                min_value=0.01,
                max_value=0.1,
                step_size=0.01,
            ...
            TunableParam(
                ...
                path="apprentice_agent.salience.high_threshold",
                current_value=0.75,
                min_value=0.6,
                max_value=0.9,
                step_size=0.05,
            ...
            TunableParam(
                ...
                path="apprentice_agent.gateway.min_confidence",
                current_value=0.5,
                min_value=0.3,
                max_value=0.8,
                step_size=0.05,
