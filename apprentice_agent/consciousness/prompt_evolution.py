...
class PromptEvolutionEngine:
    ...
    def maybe_evolve(self, module: str) -> bool:
        ...
        try:
            ...
            if row:
                ...
                cutoff = datetime.utcnow() - timedelta(days=self.RATE_LIMIT_DAYS)
    ...
    def _critique(self, module: str) -> str:
        ...
        try:
            from apprentice_agent.brain import OllamaBrain
    ...
    def _evaluate_candidates(
        ...
        try:
            from apprentice_agent.brain import OllamaBrain
            from apprentice_agent.consciousness.reward_signals import JudgeEvaluator
