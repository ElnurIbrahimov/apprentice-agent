...
Only output the improved response, nothing else."""
    ...
    def _critique(self, query: str, response: str) -> Tuple[float, List[str], List[str]]:
        ...
        try:
            ...
            logger.warning("[MirrorMind] Critique timed out, using default score")
            return 0.5, ["timeout during evaluation"], []
        except requests.RequestException as e:
            logger.warning(f"[MirrorMind] Critique API error: {e}")
            return 0.5, ["API error during evaluation"], []
    ...
    def _improve(self, query: str, response: str, issues: List[str], suggestions: List[str]) -> str:
        ...
        try:
            ...
            logger.warning("[MirrorMind] Improvement timed out, keeping current")
            return response
        except requests.RequestException as e:
            logger.warning(f"[MirrorMind] Improvement API error: {e}")
            return response
