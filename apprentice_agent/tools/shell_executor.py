...
ALLOWED_COMMANDS_PREFIX = [
    ...
    "mv", "touch", "python", "pip", "node", "npm", "git",
    "docker", "curl", "wget", "ssh", "scp", "tar", "zip", "unzip",
    "type", "where", "whoami", "hostname", "ping", "nslookup",
    "tree", "more", "less", "awk", "sed", "cut", "tr", "env",
    "set", "export", "which", "man", "help", "cls", "clear",
    "cargo", "rustc", "go", "java", "javac", "dotnet", "cmake",
    "make", "gcc", "g++", "clang", "nmap", "tracert", "traceroute",
    ...
    def _validate_command(self, command: str) -> tuple:
        ...
        for part in parts:
            ...
            if part in ("sudo", "doas"):
                continue  # Skip privilege escalation
            base_cmd = part.lower()
            break
