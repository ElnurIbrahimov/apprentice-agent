...
class ReasoningTreeTool:
    ...
    def think_deeply(
        ...
        if self._progress_callback:
            self.mcts.on_iteration_complete = self._on_iteration

        # Run search
        result = self.mcts.search(problem, context)
    ...
    def explore_options(
        ...
        result = self.mcts.search(question, context)
        self.last_result = result
        ...
        return {
            ...
            "recommendation": options[0]["description"] if options else "No clear recommendation",
    ...
    def get_reasoning_path(self) -> Dict[str, Any]:
        ...
        steps = []
        for node in self.last_result.best_path:
        ...
        return {
            "success": True,
            "steps": steps,
            "conclusion": self.last_result.best_answer,
            "confidence": round(self.last_result.confidence, 2),
        }
    ...
    def get_tree_visualization(self) -> Dict[str, Any]:
        ...
        tree_data = self.mcts.get_tree_visualization()
    ...
    def get_reflections(self) -> Dict[str, Any]:
        ...
        reflections = []
        for r in self.last_result.reflections:
            reflections.append({
                "critique": r.critique,
                "lessons": r.lessons,
        ...
        return {
            ...
            "total_lessons": sum(len(r.lessons) for r in self.last_result.reflections),
        }
